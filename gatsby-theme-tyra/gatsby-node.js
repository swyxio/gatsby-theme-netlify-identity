  ...
  return new Promise((resolve, reject) => {
    resolve(
      graphql(
        ...
        const paginationTemplate = require.resolve('./src/blog/index.js')
        ...
        let category
        let categoryPosts
        const categoryTemplate = require.resolve('./src/blog/category.js')
        ...
        const template = require.resolve('./src/blog/post.js')
