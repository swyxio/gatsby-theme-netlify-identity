      ...
      <footer className="pa2 bg-dark-gray near-white pv5">
        ...
        <div className="w-100 mw9 center silver mb3">
          ...
          <div className="flex w-100 mw6 items-center justify-center justify-start-ns">
            <a href="/sitemap.xml" className="near-white sans-serif f5 tracked pv1 db mh1">
              SITEMAP
            </a>
            <span className="mh1">|</span>
            <Link to="/privacy" className="near-white sans-serif f5 tracked pv1 db mh1">
              PRIVACY
            </Link>
            <span className="mh1">|</span>
            <a
        ...
        <div className="w-100 mw9 near-white center sans-serif f6">
